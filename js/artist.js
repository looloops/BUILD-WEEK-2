...
fetch(URL)
          ...
          .then(tracklist => {
             ...
             artistTrackList = tracklist
              for (let i = 0; i < 5; i++) {
                  const artistSongGenerate = document.createElement("div")
                  artistSongGenerate.innerHTML = `<div class="artistSong d-flex justify-content-between align-items-center mb-4" style="cursor: pointer";>
                                      <div class="d-flex align-items-center">
                                          ...
                                          <p class="nameArtistSong m-0 ms-3" style="width: 6.563rem; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${tracklist.data[i].title}</p>
                                      </div>
      ...
      let volume_up = document.querySelector(".fa-volume-up");
...
function muteTrack() {
  ...
  volume_mute.classList.remove("d-none")
  volume_mute.classList.add("d-block")
}

function removeMuteTrack() {
  curr_track.volume = 1
  volume_slider.value = 100
  volume_mute.classList.remove("d-block")
  volume_mute.classList.add("d-none")
  volume_up.classList.remove("d-none")
  volume_up.classList.add("d-block")
}
